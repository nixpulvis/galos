...
//! is a function of the system's address ([`crate::core::procedural`]), so a row
...
use crate::format::layout::ADDR_FILE;
use crate::format::layout::BYNAME_FILE;
use crate::format::layout::EXCEPTION_FILE;
use crate::format::layout::SPAN_FILE;
use crate::format::layout::TEXT_FILE;
use crate::format::layout::generation_dir;
use crate::format::layout::scratch_dir;
use crate::format::layout::{names_delta_path, names_dir, names_head_path};
...
/// function of the system's address ([`crate::core::procedural`]), so a row whose
...
impl Names {
    ...
    pub fn matching_near(
        ...
        // one sector is the case [`crate::core::procedural`]'s coordinate search
...
/// to it — [`crate::core::procedural::matches_word`], which is the same rule the
...
/// ([`crate::format::rows`]), and the sections are written from the sorted rows in
/// one pass.
///
