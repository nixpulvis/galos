...
impl Cut {
    ...
    /// them. At most one hash lookup a level down to the deepest region.
    ///
    /// Only the tests ask it: a build hands each system to its bucket, and
    /// the buckets to the regions whole.
    #[cfg(test)]
