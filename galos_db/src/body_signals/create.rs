...
impl BodySignal {
    ...
    /// about, and a kind that has stopped being reported is left alone rather
    /// than deleted -- an absent signal in one message is not evidence that it
    /// is gone, only that this message did not mention it.
