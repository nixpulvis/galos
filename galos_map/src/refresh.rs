...
//! underneath — `galos index build --from database --watch` republishes
//! every few seconds — and nothing here re-read any of it. The one way a
//! republished cell reached the map was to be evicted and fetched again,
//! which is what zooming out until the walk stops marking it and coming
//! back does. A system
