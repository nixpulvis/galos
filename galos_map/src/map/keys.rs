...
//! the map back, and `crate::input::Keyboard` is what tells the two apart. The
...
pub fn plugin(app: &mut App) {
    ...
    app.add_systems(Update, (toggle, fly, home).chain().in_set(MapSet::Search));
...
mod tests {
    ...
    use crate::map::selection::{Picked, PickedBody};
