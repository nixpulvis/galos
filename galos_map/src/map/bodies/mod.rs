...
impl Contents {
    ...
    /// to the zoom floor: `zoom_floor` in [`crate::map::camera`] holds the camera
    ...
    pub(crate) fn hold(&mut self, rows: SystemBodies) {
    ...
    pub(crate) fn middle(&self, orbits: &Orbits, since: f64) -> DVec3 {
    ...
    pub(crate) fn ridden_at(&self, id: i16) -> Option<f32> {
