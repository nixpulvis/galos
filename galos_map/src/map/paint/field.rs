...
//! [`crate::map::paint::sizing`] leaves on it.
//!
...
pub fn plugin(app: &mut App) {
    ...
    app.add_systems(
        Startup,
        spawn_field.after(crate::map::galaxy::spawn::cut_star_psf),
    );
...
///
/// The last word over [`crate::map::paint::sizing`]'s own far-field angle, which settles to
...
///
/// Read by [`build_field`] and by [`crate::map::pointing::size_indicators`], which
...
///   that did not was shrunk by [`crate::map::paint::sizing::size_photometrically`] to the
...
/// [`crate::map::paint::sizing::size_photometrically`] writes twice the star's pixel radius
...
/// [`crate::map::pointing::size_indicators`] rings and catches the pointer over
...
/// ([`crate::map::bodies::spawn::WORTH_HIDING`]). A quarter of a megabyte of
...
fn spawn_field(
    ...
    // spread ([`crate::map::galaxy::spawn::star_psf`]) — a bright core falling to nothing —
...
/// unconditional when [`crate::map::paint::glow`] landed, on the reasoning that bloom
...
pub(crate) fn build_field(
    ...
    shells: Query<
        (
            ...
            &Strength,
            Has<Filtered>,
            Option<&crate::map::route::Thinned>,
        ),
        With<Shell>,
    >,
    view: Res<View>,
    ...
    let core = crate::map::paint::sizing::stable_radius(
    ...
    for (system, drawn, visibility, strength, filtered, thinned) in &shells {
        ...
        // anyone can see. See [`crate::map::route::Thinned`].
        ...
        let color = match *view {
            ...
            // display. See [`crate::map::paint::sizing::psf_draw`].
            View::Realistic => {
                ...
                let Some((_, peak)) =
                    crate::map::paint::sizing::psf_draw(&psf, energy, core)
                else {
                    continue;
                };
        ...
        let reach = crate::map::paint::sizing::CORE_WIDTHS as f32 * core;
...
/// projected [`crate::map::bodies::spawn::Places`] instead — and at four
