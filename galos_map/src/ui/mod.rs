...
use crate::map::galaxy::{InReach, PendingEvictions, Spyglass};
...
pub(crate) struct FilterBar<'w, 's> {
    ...
    populated: Res<'w, crate::map::index::Populated>,
    names: Res<'w, crate::map::index::Names>,
}
...
mod rows {
    ...
    use crate::testing::{context, words};
    use bevy_egui::egui;
        ...
        .allocate_ui_with_layout(
            ...
            |ui| {
                ...
                if running_on {
                    ...
                    // [`crate::ui::panels::lasting`]'s. The two stand in one
...
/// [`crate::ui::panels::lasting`] writes `18.0 Earth years`, which is the
