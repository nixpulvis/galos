...
//! [`super::graph`] is worst at. The reach of a boosted jump is four times
...
//! waypoints; [`super::graph::JumpGraph`] then flies each leg with the
...
impl Highway {
    ...
    fn coarse(
        ...
        // [`super::graph::burned`] charges a whole tank for any jump at or
        ...
        while let Some((was, node)) = reached.pop() {
            ...
            if left < closest {
                ...
                // [`super::graph::Tuning::crossing`] says — stepping first,
...
/// search's own [`super::graph::Cost`]: a hop is never traded for any
